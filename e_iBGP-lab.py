...
class OSPFLab(Topo):
	...
	def build(self, *args, **kwargs):
		...
		self.addLink(R11,R2, intfName1="eth1", intfName2="eth1")
		self.addLink(R11,R3, intfName1="eth2", intfName2="eth1")
		self.addLink(R2,R3, intfName1="eth2", intfName2="eth2")
		# add links for subnet 1
		self.addLink(S11,R11, intfName2="eth0") 
		...
		R21 = self.addNode("R2", cls=LinuxRouter, ip=None, privateDirs=privateDirs, inNamespace=True)
		S2 = self.addSwitch("S2", inNamespace=True)
		R22 = self.addNode("R2_1", cls=LinuxRouter, ip=None, privateDirs=privateDirs, inNamespace=True)
		R23 = self.addNode("R2_2", cls=LinuxRouter, ip=None, privateDirs=privateDirs, inNamespace=True)
		R24 = self.addNode("R2_2", cls=LinuxRouter, ip=None, privateDirs=privateDirs, inNamespace=True)
